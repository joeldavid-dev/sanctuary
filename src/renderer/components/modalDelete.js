    ...
    return `
        <div class=" vertical-elem-area normal-margin big-spaced">
            ...
            <div class="horizontal-flex distributed">
                <button id="cancel-warning-btn" class="action-btn-warning btn-padding ultra-radius"></button>
                <button id="confirm-warning-btn" class="action-btn-warning btn-padding ultra-radius"></button>
            </div>
        </div>
        `;
}